...
@Slf4j
@Service
public class SsrshareCrawlerServiceImpl extends ShadowSocksCrawlerService {

	// 目标网站 URL
	private static final String TARGET_URL = "https://raw.githubusercontent.com/ImLaoD/sub/master/ssrshare.com";
		...
		Arrays.asList(ssrLinkList).parallelStream().forEach((str) -> {
			try {
				if (StringUtils.isNotBlank(str)) {
					...
					ss.setRemarks("ssrshare.com");
					ss.setGroup("ssrshare");
